    ...
    <BDOLayout title={applicantName}>
      ...
      <Card className="bg-white">
        <CardContent className="p-6">
          ...
          <div className="mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
              <button
                ...
                className="inline-flex items-center gap-2 text-[color:var(--t-color-accent)] hover:text-[#1d4ed8] font-medium transition-colors"
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                <nav className="text-sm text-[color:var(--t-color-text-secondary)] mb-1">
                  Individual Applicants <span className="mx-1">&rsaquo;</span> <span className="text-[color:var(--t-color-text-body)] font-medium">{applicantName}</span>
                </nav>
                <h1 className="text-[28px] font-bold text-[color:var(--t-color-text-body)]">{applicantName}</h1>
              </div>
          ...
          <div className="mb-6">
            <h4 className="text-base font-semibold text-[#1f2937] mb-4 pb-2 border-b-2 border-[var(--t-color-accent)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-[var(--t-color-border)] rounded-lg text-[15px] transition-all focus:border-[var(--t-color-accent)] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none"
              ...
              <div>
                <label className="block text-sm font-medium text-[color:var(--t-color-text-body)] mb-2 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-[color:var(--t-color-accent)] hover:text-[#1d4ed8] transition-colors"
                ...
                >
                  <SelectTrigger
                    className="w-full px-4 py-3 h-auto border border-[var(--t-color-border)] rounded-lg text-[15px]"
            ...
            {(applicant.estimatedCreditScore === '600-649' || applicant.estimatedCreditScore === 'Below 600') && (
              <div className="mb-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border border-[var(--t-color-border)] rounded-lg text-[15px] transition-all focus:border-[var(--t-color-accent)] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
              <div>
                <label className="block text-sm font-medium text-[color:var(--t-color-text-body)] mb-2">Mobile Phone Number</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-[color:var(--t-color-text-body)] mb-2">Email Address</label>
                <input
                  type="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  step="0.01"
                  disabled={isNonOwner}
                  className={`w-full px-4 py-3 border border-[var(--t-color-border)] rounded-lg text-[15px] transition-all focus:outline-none ${
                    isNonOwner
                      ? 'bg-[#f9fafb] text-[color:var(--t-color-text-secondary)] cursor-not-allowed'
                      : 'focus:border-[var(--t-color-accent)] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)]'
                  }`}
            ...
            {applicant.ownershipType === 'indirect' && (
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-[var(--t-color-border)] rounded-lg text-[15px] transition-all focus:border-[var(--t-color-accent)] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none min-h-[80px]"
            ...
            {(applicant.businessRole === 'active-full-time' || applicant.businessRole === 'active-part-time') && (
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-[var(--t-color-border)] rounded-lg text-[15px] transition-all focus:border-[var(--t-color-accent)] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.1)] focus:outline-none min-h-[100px]"
          ...
          {/* Footer Actions */}
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-[var(--t-color-border)]">
            <Button
              onClick={handleBackToOwners}
